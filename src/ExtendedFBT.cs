...
namespace Baltin.FBT
{
    ...
    public class ExtendedFbt<T> : LightestFbt<T>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Status IfVoidAction(T board,
            Status returnStatus,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Status IfInverter(T board,
            Func<T, bool> condition,
            Func<T, Status> func, 
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Status IfSelector(T board,
            Func<T, bool> condition, 
            Func<T, Status> f1,
            Func<T, Status> f2,
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Status IfVoidActions(T board,
            Func<T, bool> condition, 
            Status returnStatus, 
            Action<T> a1,
            Action<T> a2,
